...
parser.add_argument("--output-folder", type=str, dest="output_folder", help="data folder mounting point", default="")
...
torch.save(model_ft, os.path.join(output_dir,'model.pth'))
